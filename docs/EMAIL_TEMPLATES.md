...
| `WELCOME` | Clerk `user.created` webhook |
...
Audience:       Participant (Clerk email)
...
Audience:       Facilitator (Clerk email)
...
Section 1 — Details
  ...
  Facilitator ID:   {{facilitator_id}}   [Clerk user ID — not shown to participant]
