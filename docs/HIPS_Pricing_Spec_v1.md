...
**Stack (assumed):** Next.js (App Router) + TypeScript + Tailwind | PostgreSQL + Prisma | Stripe | Clerk | Vercel + Railway
...
### Auth
- Clerk handles authentication (JWT)
