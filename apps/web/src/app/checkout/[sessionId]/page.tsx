...
export default function CheckoutPage({
  ...
  return (
    <>
      <Navbar />
      <main className="min-h-screen bg-black pt-32 pb-24 px-6 selection:bg-primary/30">
        <div className="max-w-2xl mx-auto">
          <header className="mb-16 text-center">
            <div className="inline-flex items-center gap-3 px-4 py-1.5 rounded-full bg-surface/5 border border-white/10 mb-8 animate-in fade-in slide-in-from-bottom-2 duration-700">
              ...
              <span className="text-[10px] font-bold uppercase tracking-[0.3em] text-text-muted0">Secure Payment Terminal</span>
            </div>
            ...
            <p className="text-text-muted0 font-medium max-w-md mx-auto animate-in fade-in slide-in-from-bottom-6 duration-1000">
          ...
          {loading ? (
            ...
            <div className="p-12 rounded-[2rem] border border-destructive/10 bg-destructive0/5 text-center">
