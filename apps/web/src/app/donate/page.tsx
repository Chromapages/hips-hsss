          ...
          <div className="max-w-[1200px] mx-auto px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {IMPACTS.map((item) => (
                <article
                  key={item.title}
                  className="relative flex flex-col rounded-3xl border border-border bg-bg-subtle p-8 shadow-soft"
                >
                  ...
                  <h3 className="text-lg font-bold text-text font-heading mb-4">
                    {item.title}
                  </h3>
        ...
        <section className="py-20 bg-bg-subtle border-t border-border">
          <div className="max-w-[1200px] mx-auto px-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              ...
              <div className="border-l-4 border-accent pl-6 py-4 italic text-text-secondary font-body text-lg leading-relaxed">
