  ...
  return (
    <section className="bg-white px-4 py-16">
      <div className="mx-auto max-w-3xl">
        <h1 className="text-4xl font-semibold text-brand-deep">Terms of Service</h1>
        ...
        <div className="mt-8 space-y-6 text-base leading-8 text-neutral-700">
          ...
          <p>
            Payments, scholarships, package credits, and cancellations are governed by the checkout and booking terms shown at the time of purchase.
          </p>
          <p>
            In an emergency, call 988 or local emergency services immediately.
          </p>
        </div>
      </div>
    </section>
