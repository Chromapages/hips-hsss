...
export function BookingSummaryBar({
  ...
  return (
    <aside className="fixed bottom-8 left-1/2 -translate-x-1/2 z-50 w-[calc(100%-2rem)] max-w-4xl animate-in fade-in slide-in-from-bottom-8 duration-500">
      <div className="rounded-3xl border border-white/10 bg-black/60 p-4 shadow-2xl shadow-primary/10 backdrop-blur-3xl ring-1 ring-white/5">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between px-2">
          <div className="flex items-center gap-4">
            <div className="hidden sm:flex w-12 h-12 rounded-2xl bg-primary/10 border border-primary/20 items-center justify-center text-xl">
              ✨
            </div>
            <div>
              <p className="text-[10px] font-bold uppercase tracking-[0.2em] text-text mb-0.5">Selected Session</p>
