...
const config = {
  ...
  "inlineSchemaHash": "e0303704eae94c1bc9e039ed5894acf6a6e9f79043ad234ea936997756707a4e",
  "copyEngine": true
}
...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "packages/db/generated/commerce",
    "db/generated/commerce",
  ]
...
path.join(process.cwd(), "packages/db/generated/commerce/libquery_engine-darwin-arm64.dylib.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "packages/db/generated/commerce/schema.prisma")
